...
public class FrmRelatorioEmprestimo extends javax.swing.JFrame {
    ...
    public FrmRelatorioEmprestimo() {
        ...
        this.DevoluçãoDAO = new DevoluçãoDAO(); //Carrega objetodevolução de Devolução
        this.carregaTabela();
    }
    ...
    if (respostaUsuario == 0) {
        ...
        if (emprestimoDAO.deleteEmprestimoBD(id)) {
            try {
                ...
                if (devolucaoDAO.insertDevoluçãoBD(new Devolução(nomeAmigo, idFerramenta, dataTexto, 0, NomeDaFerramenta))) {
                ...
                System.out.println(devolucaoDAO.getListaDevolução().toString());
